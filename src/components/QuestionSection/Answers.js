...
export const Answers = () => {
    return (
        <Container className='container-answers'>
            <Row className='row-answer justify-content-center align-items-center my-1 mx-3'>
                ...
                <Col xs={10} md={10} xl={7} className='ans-col my-4'>
                    <div className="ans-rectangle-1">
                        <Col className="ans-text">
                            <div className="ans-text-header">Гимнастика</div>
                            <div className="ans-text-description mt-1">Это направление не классической художественной
                                гимнастики, мы занимаемся растяжкой, постановкой корпуса и изучением различных
                                интересных
                                элементов.
                            </div>
                        </Col>
            ...
            <Row className='row-answer justify-content-center align-items-center my-1 mx-3'>
                <Col xs={10} md={10} xl={7} className='ans-col order-2 order-md-2 order-xl-1 my-4'>
                    <div className="ans-rectangle-1">
                        <Col className="ans-text">
                            <div className="ans-text-header">Акробатика</div>
                            <div className="ans-text-description mt-1">На занятиях мы изучаем всю базовую
                                акробатику, после
            ...
            <Row className='row-answer justify-content-center align-items-center my-1 mx-3'>
                ...
                <Col xs={10} md={10} xl={7} className='ans-col order-2 order-sm-2 order-md-2 order-xl-2 my-4'>
                    <div className="ans-rectangle-1">
                        <Col className="ans-text">
                            <div className="ans-text-header">Эстрадная хореография</div>
                            <div className="ans-text-description mt-1">Это не просто заученные движения, а театральная
